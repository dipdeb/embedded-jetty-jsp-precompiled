...
public class Main
{
    ...
    public void start() throws Exception
    {
		...
		servletContextHandler.setResourceBase("src/main/resources/webroot");
		...
		servletContextHandler.addServlet(org.apache.jasper.servlet.JspServlet.class, "*.jsp");
		servletContextHandler.setAttribute("javax.servlet.context.tempdir", new File("target/jsp"));
